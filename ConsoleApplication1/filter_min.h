...
/// <summary>
	/// Specjalny filtr bazujacy na macierzy, wybierajacy najmniejszy element w zasiegu.
	/// </summary>
...
class filter_min : protected filter
{
public:
	/// <summary>
	...
	/// <summary>
	/// przeciazenie, wirtualna metoda uzywajaca specjalnego typu filtrowania, w tym przypadku wybiera element najmniejszy z zasiegu
	/// </summary>
